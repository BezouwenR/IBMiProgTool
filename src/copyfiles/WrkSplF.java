 ...
 */
public class WrkSplF extends JFrame {
    ...
    */
   public void createSpoolWindow(boolean currentUser) {
      ...
      panelTop = new JPanel();
      panelTop.setPreferredSize(new Dimension(windowWidth - 20, 60));
      panelTop.setMinimumSize(new Dimension(windowWidth - 20, 60));
      panelTop.setMaximumSize(new Dimension(windowWidth - 20, 60));
      ...
      setLocation(compileWindowX + 40, compileWindowY + 40);
      setVisible(true);
      ...
      refreshButton.addActionListener(ae -> {
         ...
         selectSpooledFiles(namePar, numberPar, pagesPar, "", userPar, jobNumberPar, datePar, timePar);
