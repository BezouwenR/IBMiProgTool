...
public class SearchMatchingFiles extends SwingWorker<String, String> {
    ...
    protected void searchMatchingFiles() {
        ...
        for (int idx = 0; idx < mainWindow.clipboardPathStrings.length; idx++) {
            mainWindow.sourcePathString = mainWindow.clipboardPathStrings[idx];
            ...
            if (Objects.nonNull(searchWindow.pattern)) {
                ...
                searchWindow.filePathsArrList.add(mainWindow.clipboardPathStrings[idx]);
